...
![The following diagram shows the integration of the static code analysis factor in the pipeline.](docs-images/GOF_Creational.jpg)
...
![The following diagram shows the integration of the static code analysis factor in the pipeline.](docs-images/GOF_Structural.jpg)
...
![The following diagram shows the integration of the static code analysis factor in the pipeline.](docs-images/GOF_Behavioral.jpg)


Following Documents are a good read on GoF Patterns:
